...
import { Truck, Users, FileText, Settings, MapPin, Search } from 'lucide-react';
      ...
      <header className="bg-brand-700 text-white shadow-lg sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <nav className="flex space-x-6">
            <button className="flex items-center space-x-1 hover:text-brand-100 transition"><FileText className="w-5 h-5"/> <span>Informes</span></button>
            <button className="flex items-center space-x-1 hover:text-brand-100 transition"><Users className="w-5 h-5"/> <span>Técnicos</span></button>
            <button className="flex items-center space-x-1 hover:text-brand-100 transition"><Settings className="w-5 h-5"/> <span>Repuestos</span></button>
          </nav>
        </div>
      </header>
